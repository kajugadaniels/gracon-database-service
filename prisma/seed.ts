// Database seed script — creates the first SUPER_ADMIN account.
...
import { AdminRole, createPrismaClient } from '../src';

if (!process.env.DATABASE_MIGRATION_URL) {
  console.error('❌ DATABASE_MIGRATION_URL environment variable is not set');
  process.exit(1);
}
